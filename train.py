...
from src.trainer import Reinpainting
...
def main_worker(gpu, args):
    ...
    model = Reinpainting(config, gpu, rank)
...
if __name__ == "__main__":
    ...
    parser.add_argument('--path', '--checkpoints', type=str, default=None,
                        help='model checkpoints path (default: ./checkpoints/ZITS_grad)')
    parser.add_argument('--config_file', type=str, default='/root/autodl-tmp/ZITS_inpainting/config_list/config_LAMA.yml',
